...
PlayerStation::PlayerStation() : _collider(glm::vec2(), glm::vec2()) {

}

void PlayerStation::init(std::string texture, glm::vec4 destination, glm::vec4 boundingBox, glm::vec2 anchorPointOffset) {
