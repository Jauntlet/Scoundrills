...
void MainGame::run() {
	...
	Jauntlet::UIButtonElement* _button = new Jauntlet::UIButtonElement(&_inputManager, _bruh, _buttonTexture, glm::vec2(10,10), glm::vec2(128,128), Jauntlet::UIElement::ORIGIN_PIN::LEFT);
