...
private:
	...
	UIButton _startButton = UIButton(&GlobalContext::inputManager, std::bind(&MainMenu::toggleSavesMenu, this), _buttonTexture, &_startButtonPos, glm::vec2(600, 200), UIElement::ORIGIN_PIN::CENTER);
	...
	UIButton _settingsButton = UIButton(&GlobalContext::inputManager, std::bind(&MainMenu::toggleSettingsMenu, this), _buttonTexture, &_settingsButtonPos, glm::vec2(600, 200), UIElement::ORIGIN_PIN::CENTER);
	...
	UIButton _quitButton = UIButton(&GlobalContext::inputManager, std::bind(&MainMenu::quitGame, this), _buttonTexture, &_quitButtonPos, glm::vec2(600, 200), UIElement::ORIGIN_PIN::CENTER);
	...
	UIButton _noButton = UIButton(&GlobalContext::inputManager, std::bind(&MainMenu::startGame, this), _buttonTexture, &_noButtonPos, glm::vec2(600, 200), UIElement::ORIGIN_PIN::TOP);
	...
	UIButton _yesButton = UIButton(&GlobalContext::inputManager, std::bind(&MainMenu::startTutorial, this), _buttonTexture, &_yesButtonPos, glm::vec2(600, 200), UIElement::ORIGIN_PIN::TOP);
